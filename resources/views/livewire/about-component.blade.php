            ...
            <div class="our-staff">
                <div class="slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false"
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="{{ $team_member->name }}">
                                <figure><img src="assets/images/{{ $team_member->image }}" alt="{{ $team_member->image_alt }}"></figure>
                            </a>
                        </div>
                        <div class="info">
                            <b class="name">{{ $team_member->name }}</b>
                            <span class="title">{{ $team_member->position }}</span>
                            <p class="desc">{{ $team_member->introduction }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
