        ...
        <div class=" main-content-area">
            ...
            @else
                <div class="text-center" style="padding: 30px 0;">
                    ...
                    <a href="/shop" class="bnt btn-success btn-lg">Shop Now</a>
                </div>
            @endif
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{ asset('assets/images/products')}}/{{$favourit->product->image}}" width="214" height="214')}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">{{ $favourit->product->stock_status }}</span>
                                </div>
                                <div class="wrap-btn">
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>{{ $favourit->product->name }}</span></a>
                                <div class="wrap-price"><span class="product-price">${{ $favourit->product->regular_price }}</span></div>
                            </div>
                        </div> 
                    @endforeach
                        {{-- <div class="product product-style-2 equal-elem ">
                     ...
                     {{--      <div class="product product-style-2 equal-elem ">
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{ asset('assets/images/products/digital_14.jpg')}}" width="214" height="214')}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">new</span>
                                </div>
