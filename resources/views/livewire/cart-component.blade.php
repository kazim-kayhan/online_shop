                    ...
                    <div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
                            ...
                            <p class="summary-info total-info "><span class="title">Total</span><b
                                    class="index">${{ number_format($totalAfterDiscount) }}</b></p>
                        @else
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img
                                                src="{{ asset('assets/images/products') }}/{{ $favourit->product->image }}"
                                                width="214" height="214')}}"
                                                alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
                                    <div class="group-flash">
                                        <span
                                            class="flash-item new-label">{{ $favourit->product->stock_status }}</span>
                                    </div>
                                    <div class="wrap-btn">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span
                                            class="product-price">${{ $favourit->product->regular_price }}</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
