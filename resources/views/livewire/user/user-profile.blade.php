<div>
    <div class="container">
        <div class="row">
            <div class="pane panel-default"> Profile </div>
            <div class="panel-body">
                <div class="col-md-4"> @if($user->profile->image) <img src="{{ asset('assets/images/profile') }}/{{ $user->profile->image }}" alt="{{ $user->name }} photo" width="100%"> @else <img src="{{ asset('assets/images/profile/default.png') }}" alt="{{ $user->name }} photo" width="100%"> @endif </div>
                <div class="col-md-8">
