                            ...
                            <div class="wrap-address-billing">
                                ...
                                <div class="shipping-adress">
                                    <p class="row-in-form">
                                        ...
                                        @error('s_firsName') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input type="text" name="s_line1" value="" placeholder="line1" wire:model="s_line1">
                                        @error('s_line1') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="s_line2">Line2</label>
                                        <input type="text" name="s_line2" value="" placeholder="line2" wire:model="s_line2">
                                        @error('s_line2') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="s_country">Country<span>*</span></label>
                                        <input type="text" name="s_country" value="" placeholder="Country name" wire:model="s_country">
                                        @error('s_country') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="s_province">Province<span>*</span></label>
                                        <input type="text" name="s_province" value="" placeholder="Province name" wire:model="s_province">
