                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateCoupon">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Coupon Type" class="form-control input-md" wire:model="code">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="from-control" wire:model="type">
                            ...
                            <div class="form-group">
                                <label for="cart_value" class="col-md-4 control-label">Expiry Date</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-rimary">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
